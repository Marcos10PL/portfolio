...
type RepositoryData = RepositoriesData[keyof RepositoriesData]
...
const repositories: RepositoriesData = {
  ...
  games: {
    name: "Games",
    description:
      "Strona z grami takimi jak: kółko i krzyżyk, memory, wisielec, kamień-papier-nożyce. Gry mają różne tryby.",
    tech: ["React.js"],
  },
  "to-do-list": {
    name: "To Do List",
    description:
      "Interaktywna lista to-do, którą można dowolnie zarządzać. Lista jest zapisywana na bieżąco w plikach cookies.",
    tech: ["TypeScript"],
  },
  "movie-center": {
    name: "Movie Center",
    description:
      "Centrum filmowe, w którym można przeglądać i zarządzać ulubionymi filmami.",
